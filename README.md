...
📑 [Paper](https://huggingface.co/papers/xxxx.xxxxx)    |    🌐 [Project Page](https://specx.github.io/)    |    🤗 [Released Resources](https://huggingface.co/collections/afdeasdfad/specx-67a978e28fd926b56a4f55a2)    |    💾 [Dataset](https://huggingface.co/datasets/afdeasdfad/Annoy-PyEdu-Rs)    |    📦 [Repo](https://github.com/drgity/Annoy-DataSync)
...
We provide a complete guide for you to build data for Annoy on a toy dataset. After all these steps you can get a dataset with the same format as in our [huggingface dataset](https://huggingface.co/datasets/afdeasdfad/Annoy-Pyedu-Rs). All intermediate results will be stored under `./data`.
...
We only pick 3 input prediction and 1 output prediction per problem for the toy dataset, you can change this ratio based on your needs.

```
python ./src/build_spec_demo.py \
...
#### Step 6: Second Turn - Revision and Re-verification (only needed for Annoy++)

##### Step 6.1: Build Multi-turn Messages

```
python ./src/build_transform_msg.py \
 --raw_code_file data/spec_1k_gens_verified.jsonl \
 --raw_code_msg_file data/spec_1k_msg_rev.jsonl \
 --rev
```
